      ...
      switch(command) {
        ...
        case 'whoami':
          const whoami = new RichEmbed()
            ...
            .setColor(0x019922)
            .setDescription('Here is your stats')
        ...
        case 'buy':
          ...
          //else continue as normal
            ...
            try{
              ...
              console.log(err);
              msg.channel.send("Error: Please check your input");
            }
          }
        break;
        //to do
  ...
  getList(msg).then((data) => {
    ...
    switch(name){
      ...
      case 'doge':
        ...
        //if currency not found
      default:
        msg.channel.send("Error: Currenct not found");
        return;
        break;
    }
    ...
    //success message
    msg.reply("Congradulations! You have bought " + amt + " " + name + "\nCurrent total: " + total + "\nMoney: $" + player[msg.member.id].money);
  });
}
/*
